            ...
            <header>
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 md:flex md:items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <button v-if="checkedResponses.length" @click="deleteSubmissions" type="button" class="inline-flex mt-4 md:mt-0 items-center rounded-md border border-transparent bg-red-600 text-white px-4 py-2 text-xs  shadow-sm hover:bg-red-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
...
<script setup>
    ...
    async function downloadResponses() {
        ...
        a.href = url;
        a.download = 'responses-file'; // Set the desired file name
