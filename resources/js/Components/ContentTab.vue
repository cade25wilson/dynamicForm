<template>
    ...
    <div>
        <div class="mt-6 border-b border-gray-100 pb-4" v-if="![3, 4, 5, 6, 8, 9, 10].includes(page.props.current_section.section_type_id)">
            <div class="flex items-center justify-between">
    ...
    <TextAlign v-if="![3, 4, 5, 6, 8, 9, 10].includes(page.props.current_section.section_type_id)" />
    ...
    <DropDown v-if="[10].includes(page.props.current_section.section_type_id)" />
    <div class="mt-6">
    ...
    <div class="mt-6 pt-6" v-if="![8, 9, 10].includes(page.props.current_section.section_type_id)">
        <div class="flex items-center justify-between">
...
import DropDown from './DropDownOption.vue';
