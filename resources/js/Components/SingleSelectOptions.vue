<template>
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:px-14 sm:py-6">
                                ...
                                <div class="w-full">
                                    <div>
                                        ...
                                        <div>
                                            <div class="my-5 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-white">
    ...
    <p class="text-center text-sm text-gray-500" v-if="loading">
      Uploading...
                                        ...
                                        <div x-show="mode == 'link'" class="my-10" style="display: none;">
                                            ...
                                            <div class="mt-2">
                                                <div class="flex w-full rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-600"> 
                                                    <input x-ref="linkInput" @keydown.enter="addViaLink" type="text" class="block w-full flex-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="https://beautifulimage.com/cat.png">
